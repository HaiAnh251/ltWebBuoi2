 ...
 <!-- BEGIN CONTENT -->
          <div class="col-md-12 col-sm-12">
			...
			<h2 class="alert alert danger">${alert}</h2>
                  ...
                  <form  action="${pageContext.request.contextPath }/views/login" method="post" class="form-horizontal form-without-legend" role="form">
                    ...
                    <div class="row">
                      <div class="col-lg-8 col-md-offset-4 padding-left-0">
                        <a href="${pageContext.request.contextPath }/views/forgotpass">Forget Password?</a>
                      </div>
                    </div>
                    <div class="row">
